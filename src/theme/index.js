...
const theme = {
	...
	color: {
		...
		gradientSecondary: 'linear-gradient(120deg, #1f262d 7%, #514695 38%, #30cee7 97%);'
	},
	grey: {
		dark: '#151a1f',
		semiDark: '#474b4f',
	...
	font: {
		boldItalic: 'AmericaBoldItalic',
		bold: 'AmericaBold',
		lightItalic: 'AmericaLightItalic',
		light: 'AmericaLight',
		mediumItalic: 'AmericaMediumItalic',
		medium: 'AmericaMedium'
	},
	fontSize: {
		heading1: '2.5rem',
		heading2: '2rem',
